...
(defun enzuru-arrange-workspace ()
  ...
  (enzuru-setup-tab "scheme" "*Geiser Guile REPL*")
  (enzuru-setup-tab "golang" "snippet.go")
  (enzuru-setup-tab "elixir" "*Inf-Elixir*")
  (enzuru-setup-tab "haskell" "*haskell*")
  (enzuru-setup-tab "python" "*Python*")
  (enzuru-setup-tab "ruby" "*ruby*")
  (enzuru-setup-tab "rust" "main.rs")
  (enzuru-setup-tab "common lisp" "*sly-mrepl for sbcl*")
