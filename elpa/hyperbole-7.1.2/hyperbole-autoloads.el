...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "hact" '("defact" "act" "hrule:action" "htype:create" "hact" "sym")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "hactypes" '("text-toc" "rfc-toc" "man-show" "link-to-" "hyp-" "function-in-buffer" "eval-elisp" "exec-" "display-" "completion" "annot-bib")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "hbut" '("ibut:" "ibtype:create" "defib" "map-" "hattr:summarize" "hbut:" "ebut:")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "hgnus" '("rnews:" "lnews:to")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "hibtypes" '("ctags" "cscope" "completion" "annot-bib" "action" "hlink" "hibtypes-path-line-and-col-regexp" "hyp-" "Info-node" "glink" "grep-msg" "gnus-push-button" "tex" "parse-label-and-file" "pat" "etags" "eli" "dir-summary" "debugger-source" "rfc" "ripgrep-msg" "id-cflow" "ilink" "ipython-stack-frame" "mail-address" "markdown-" "man-apropos" "function-in-buffer")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "hmail" '("hnews:" "hmail:" "rmail:")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "hmouse-drv" '("smart-scroll-" "hkey-" "hmouse-" "quit-window" "mouse-drag-mode-line" "action-" "assist-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "hsettings" '("hkey-always-display-menu" "hmouse-middle-flag" "hyperbole-" "hui:but-flash" "inhibit-hyperbole-messaging" "smart-scroll-proportional")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "hsys-org" '("hsys-org-" "org-" "inhibit-hsys-org")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "hui-menu" '("hyperbole-" "hui-menu-" "infodock-hyperbole-menu")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "hui-mouse" '("smart-" "last-line-p" "first-line-p" "hkey-" "hmouse-" "action-key-" "assist-key-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "hui-window" '("hmouse-" "action-key-m" "assist-key-m" "smart-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "hyrolo-menu" '("hyrolo-" "infodock-hyrolo-menu" "id-")))
